...
if ( $show_more_toggle AND ! us_amp() ) {
	...
	$output .= '<a href="javascript:void(0)" class="collapsible-content-more">' . strip_tags( $show_more_toggle_text_more ) . '</a>';
	$output .= '<a href="javascript:void(0)" class="collapsible-content-less">' . strip_tags( $show_more_toggle_text_less ) . '</a>';
	$output .= '</div>';
}
