...
<div<?php echo us_implode_atts( $_atts ) ?>>
	...
	<div id="payment" class="woocommerce-checkout-payment">
		...
		<div class="form-row place-order">
			...
			<?php echo apply_filters( 'woocommerce_order_button_html', '<button type="submit" class="w-btn us-btn-style_' . $btn_style . '" name="woocommerce_checkout_place_order" value="' . esc_attr( $btn_label ) . '"><span class="w-btn-label">' . strip_tags( $btn_label ) . '</span></button>' ); ?>
